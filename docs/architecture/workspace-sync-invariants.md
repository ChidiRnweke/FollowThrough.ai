...
| SYNC-READINESS  | Cached records open immediately, without a storage read. Partial inventory never proves absence.                     | Resource view access, cached startup, inventory barrier and preference tests. |
