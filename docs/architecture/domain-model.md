...
| --------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| Task fields or completion status        | `services/todos/edits.ts`: `applyTodoEdit`; `server/controllers/todos/controller.ts`: `update`; `server/services/todos/catalog.ts`: `getForEdit`, `update`                             | `server/services/todos/catalog.spec.ts`                                                                                                              |
| Folder placement or sibling order       | `server/services/projects/catalog.ts`: `decideProjectEntryMove`; `services/notes/creation.ts`: `decideNoteCreation`                                                                    | `server/services/projects/catalog.spec.ts`; `controllers/workspace/command-creation.spec.ts`                                                         |
