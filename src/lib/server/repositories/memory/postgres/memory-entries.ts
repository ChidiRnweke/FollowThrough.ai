...
import * as schema from '$lib/server/db/schema/memory';
import { toMemoryEntry } from '$lib/server/db/mappers';

export class MemoryRecords implements MemoryEntryRepository {
