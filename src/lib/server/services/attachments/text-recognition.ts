...
export interface TextRecognitionOptions extends LanguageModelClientOptions {
...
export const annotationParts = (annotations: readonly OcrFileAnnotation[]): RecognizedContent[] => {
...
export class TextRecognition implements ITextRecognition {
