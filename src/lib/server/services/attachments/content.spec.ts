...
import { AttachmentContent, OCR_SINGLE_REQUEST_PAGE_LIMIT, OCR_SPLIT_RANGE_PAGES } from './content';
...
const setup = (pages: number) => {
	...
	const service = new AttachmentContent(engine, describer, splitter);
	return { engine, describer, splitter, service };
};

const bytes = new Uint8Array([1, 2, 3]);

describe('AttachmentContent split decisions', () => {
