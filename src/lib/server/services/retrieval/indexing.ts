...
import type { IndexSource, RetrievalIndexRepository } from '$lib/server/repositories';
...
const countRetrievalTokens = (value: string): number => retrievalEncoding().encode(value).length;
