...
export function buildAgentInstructions(
	...
	const notePreservation =
		...
		"For any typed identifier, copy the matching id field returned by a FollowThrough tool; never substitute a human-readable name or a different entity's id. If the exact id is unknown, omit an optional filter or read workspace state before calling a tool that requires it.\n\n";
