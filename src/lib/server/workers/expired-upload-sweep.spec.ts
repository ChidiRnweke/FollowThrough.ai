...
import type { OwnedAttachmentUpload } from '$lib/repositories';
import { ExpiredUploadSweepTask } from './expired-upload-sweep';
...
const sweep = (store: FakeUploadStore, objects: FakeObjectStore, graceMs = 60 * 60 * 1000) =>
	new ExpiredUploadSweepTask(
		store as unknown as ConstructorParameters<typeof ExpiredUploadSweepTask>[0],
		objects as unknown as ConstructorParameters<typeof ExpiredUploadSweepTask>[1],
