...
import type { AgentRunEventRecord, AgentRunId } from '$lib/models/agent';
...
const record = (cursor: string): AgentRunEventRecord => ({
	runId,
	cursor,
	attempt: 1,
...
const setup = (onEvent: (event: AgentRunEventRecord) => Promise<void> | void) => {
