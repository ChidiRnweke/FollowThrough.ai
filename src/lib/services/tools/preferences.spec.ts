...
import { PersistentToolPreferenceStore, type ToolCatalog } from './preferences';
...
const store = () =>
	((repository) => ({ repository, store: new PersistentToolPreferenceStore(repository, catalog) }))(
