...
import type { AgentPreferencesRepository } from '$lib/repositories';
...
export class PersistentAgentPreferencesStore implements AgentPreferencesStore {
...
export class OpenRouterModelCatalog implements AgentModelCatalog {
