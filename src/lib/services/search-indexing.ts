...
import type { ContentChunker, EmbeddingClient } from './knowledge';
import type { DiagramIndexer } from './diagrams';
import type { NoteIndexer } from './notes';
...
export class EmbeddedDiagramIndexer implements DiagramIndexer {
	constructor(
		private readonly repository: RetrievalIndexRepository,
		private readonly embeddingClient: EmbeddingClient,
		private readonly noteReader: import('./notes').NoteReader,
		private readonly chunker: ContentChunker = new ParagraphChunker()
	) {}
