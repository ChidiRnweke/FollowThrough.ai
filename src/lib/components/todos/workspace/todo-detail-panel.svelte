<script lang="ts">
	...
	import TodoResponsibilityField from '../fields/todo-responsibility-field.svelte';
	import TodoSourceField from '../fields/todo-source-field.svelte';
	import ConfirmDelete from '../../shared/confirm-delete.svelte';
