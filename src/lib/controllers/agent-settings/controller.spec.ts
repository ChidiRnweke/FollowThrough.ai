...
import type { AgentModelCatalog, AgentPreferencesStore } from '$lib/services';
import { testActor, testNow } from '$lib/testing/fixtures/domain-builders';
import { DefaultAgentSettingsController } from './controller';
...
const setup = () => {
	...
	return {
		preferences,
		models,
		controller: new DefaultAgentSettingsController({ preferences, models })
	};
};
