...
import { PersistentToolPreferenceStore, type ToolCatalog } from '$lib/services';
...
import { DefaultToolPreferencesController } from './controller';
...
const controller = () =>
	new DefaultToolPreferencesController({
		preferences: new PersistentToolPreferenceStore(new InMemoryToolPreferenceRepository(), catalog)
	});
