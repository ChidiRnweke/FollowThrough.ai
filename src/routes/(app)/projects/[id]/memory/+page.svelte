...
{#if project && !project.archivedAt}
	<PageShell
		title="Memory"
		description="Durable facts, decisions, constraints, and preferences for {project.name}."
	>
		...
		{/snippet}
		{#snippet actions()}
			<AgentAction action={agentActions.projectDistil} context={{ projectId: project.id }} />
		{/snippet}
		<MemoryEntryList
